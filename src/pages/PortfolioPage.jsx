...
export default function PortfolioPage() {
  return (
    <div className="relative overflow-hidden py-12 md:py-20">
      {/* Cinematic Ocean Trade Corridor Dimmed Background */}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-12">
        ...
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          >
            An overview of the global trade lanes and multimodal freight
            networks served by Connect Continents Logistics.
          </motion.p>
        </div>
          ...
          <div className="relative z-10 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="max-w-xl font-body text-xs text-neutral-400 md:text-sm">
                We coordinate origin-to-destination routes worldwide. Submit
                your shipment origin and destination to receive carrier schedule
